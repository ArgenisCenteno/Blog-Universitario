		...
		<div class="container-fluid">
			<form action="" id="manage-category">
				...
				<div class="form-group">
					<label for="" class="control-label">Agregar imagen</label>
						<div>
						...
						<br>
							<div class="input-group mb-3 col-md-3">
							  ...
							  <div class="custom-file">
							    ...
							    <label class="custom-file-label" for="img">Elegir archivo</label>
							  </div>
							</div>
						</div>
				</div>
				<div class="form-group">
					<label for="post" class="control-label">Descripción</label>
				...
				<center><button class="btn btn-primary btn-block col-md-2">Guardar</button></center>
			</form>
		</div>
		<script>
	$('.text-jqte').jqte();

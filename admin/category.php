<div class="container-fluid">
	<div class="card col-md-12">
		<div class="card-body">
			<div class="col-md-12">
				<button type="button" class="btn btn-primary btn-sm btn-block col-sm-2" id="new_category"><i class="fa fa-plus"></i> Agregar Categoría</button>
			</div>
			<br>
			<div class="col-md-12">
	...
	<script>
					...
					if(typeof resp != undefined){
						...
						if(Object.keys(resp).length > 0){
							...
							Object.keys(resp).map(k=>{
								...
								tr.append('<td><center><button class="btn btn-info btn-sm edit_category" data-id = "'+resp[k].id+'"><i class="fa fa-edit"></i> Editar</button><button class="btn btn-danger btn-sm remove_category" data-id = "'+resp[k].id+'"><i class="fa fa-trash"></i> Eliminar</button></center></td>')
		...
		function manage_category(){
			$('.edit_category').click(function(){
				uni_modal("Editar Categoría",'manage_category.php?id='+$(this).attr('data-id'))
			})
			$('.remove_category').click(function(){
				// console.log('REMOVE')
				_conf("¿Estas seguro de querer eliminar?",'remove_category',[$(this).attr('data-id')])
			})
		}
